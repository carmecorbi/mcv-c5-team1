...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_path', help="Path to the images directory.", default="/ghome/c5mcv01/mcv-c5-team1/week5/data/images")
    parser.add_argument('--train_csv_path', help="Path to the training CSV file.", default="/ghome/c5mcv01/mcv-c5-team1/week5/data/train.csv")
    parser.add_argument('--val_csv_path', help="Path to the validation CSV file.", default="/ghome/c5mcv01/mcv-c5-team1/week5/data/val.csv")
    parser.add_argument('--test_csv_path', help="Path to the test CSV file.", default="/ghome/c5mcv01/mcv-c5-team1/week5/data/test.csv")
    ...
    parser.add_argument("--lora_dropout", help="LoRA dropout parameter for LLM finetuning.", default=0.5, type=float)
    ...
    if args.task == "train":
        ...
        # Create datasets
        test_dataset = vision.ImageDataset(test_df, "/ghome/c5mcv01/mcv-c5-team1/week5/data/images", image_processor, is_test=True)
        train_dataset = vision.ImageDataset(train_df, "/ghome/c5mcv01/mcv-c5-team1/week5/data/images", image_processor, is_test=True)
        val_dataset = vision.ImageDataset(val_df, "/ghome/c5mcv01/mcv-c5-team1/week5/data/images", image_processor, is_test=True)
