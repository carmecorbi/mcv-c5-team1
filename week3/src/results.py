...
checkpoint_path = "/ghome/c5mcv01/mcv-c5-team1/week3/results/word_tokenizer_baseline/version_6/checkpoints/epoch=5-step=1080.ckpt"
...
caption_text = sample_caption.cpu().numpy()[2]

gt_caption = word_tokenizer.decode(caption_text)
...
predicted_tokens = output.argmax(dim=-1).cpu().numpy()[2]  
predicted_caption = word_tokenizer.decode(predicted_tokens)  


# Mostrem la predicció i el nom de la imatge
print(f"Nom de la imatge: {gt_caption}")
print(f"Predicció del model: {predicted_caption}")
