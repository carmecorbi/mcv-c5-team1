...
def run_inference(sequence_id):
    ...
    output_dir = f"/ghome/c5mcv01/mcv-c5-team1/week2/src/huggingface/results/inference_ft_fu/{sequence_id}"
    os.makedirs(output_dir, exist_ok=True)  # Create output directory if it doesn't exist

    # Load the Mask2Former model and image processor
    processor = AutoImageProcessor.from_pretrained("/ghome/c5mcv01/mcv-c5-team1/week2/src/huggingface/finetune-instance-segmentation-ade20k-mini-mask2former_augmentation/checkpoint-1890")
    model = Mask2FormerForUniversalSegmentation.from_pretrained("/ghome/c5mcv01/mcv-c5-team1/week2/src/huggingface/finetune-instance-segmentation-ade20k-mini-mask2former_augmentation/checkpoint-1890")
